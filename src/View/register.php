    ...
    <div class="bg-white border rounded-5">
                                        ...
                                        >
                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="form2Example11"
                                                       style="margin-left: 0px;">Full name</label>
                                            ...
                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="form2Example11"
                                                       style="margin-left: 0px;">Phone number</label>
                                            ...
                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="form2Example22"
                                                       style="margin-left: 0px;">Conform password</label>
                                                <input type="password" name="confirmPassword"
                                                       id="inputConfirmPassword"
                                                       class="form-control" placeholder="Confirm password"
                                                       value="<?= $data['confirmPassword'] ?? '' ?>" required>
                                                <div class="form-notch">
                                                    <div class="form-notch-leading" style="width: 9px;"></div>
                                                    <div class="form-notch-middle" style="width: 64px;"></div>
                                                    <div class="form-notch-trailing"></div>
        ...
        ' . $data["error"]["incorrect"] . '
                                            ...
                                            <div class="text-center pt-1 mb-5 pb-1">
                                                <button class="btn btn-primary btn-block border-0 py-3 fa-lg gradient-custom-2 mb-3"
                                                        type="submit">Sign up
                                                </button>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-center pb-4">
                                                ...
                                                <a href="/login" class="btn btn-outline-danger"> Login
                                                </a>
                                            </div>
